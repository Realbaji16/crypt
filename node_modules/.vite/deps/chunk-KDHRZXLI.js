...
var ProviderUtil = {
  ...
  reset() {
    state2.providers = { ...CLEAN_PROVIDERS_STATE };
    state2.providerIds = { ...CLEAN_PROVIDERS_STATE };
  },
...
var AppKit = class {
  ...
  async initControllers(options) {
    ...
    if (evmAdapter) {
      if (options.siweConfig) {
        ...
        const siwe = await import("./exports-TZQG6O7I.js");
  ...
  async listenAuthConnector(provider) {
    ...
    provider.onNotConnected(() => {
      ...
      const isConnectedWithAuth = connectedConnector === ConstantsUtil3.AUTH_CONNECTOR_ID;
    ...
    if (isConnected && ((_a = this.connectionControllerClient) == null ? void 0 : _a.connectExternal)) {
      await ((_c = this.connectionControllerClient) == null ? void 0 : _c.connectExternal({
        id: ConstantsUtil3.AUTH_CONNECTOR_ID,
        info: { name: ConstantsUtil3.AUTH_CONNECTOR_ID },
        type: ConstantsUtil3.CONNECTOR_TYPE_AUTH,
        provider,
  ...
  async syncExistingConnection() {
    ...
    } else if (connectedConnector !== ConstantsUtil3.CONNECTOR_TYPE_W3M_AUTH) {
      this.setStatus("disconnected", ChainController.state.activeChain);
    }
  }
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([
          import("./esm-BPLJZLGO.js"),
          import("./w3m-modal-L6RGZK2C.js")
        ]);
...
//# sourceMappingURL=chunk-KDHRZXLI.js.map
