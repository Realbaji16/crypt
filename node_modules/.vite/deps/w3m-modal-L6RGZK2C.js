...
var W3mModal = class W3mModal2 extends LitElement {
  ...
  onNewNetwork(nextCaipNetwork) {
    ...
    if (prevCaipNetworkId && nextNetworkId && prevCaipNetworkId !== nextNetworkId && ((_d = this.caipNetwork) == null ? void 0 : _d.name) !== "Unknown Network") {
      RouterController.goBack();
    }
    this.caipNetwork = nextCaipNetwork;
  }
...
//# sourceMappingURL=w3m-modal-L6RGZK2C.js.map
